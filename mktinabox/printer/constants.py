...
Since there is no definitive and unified specification for all esc/pos-like printers.
...
# Paper Cutter
CUT_PAPER = lambda m: GS + b'V' + m
PAPER_FULL_CUT_A = CUT_PAPER(b'\x00')  # Full cut paper function A
PAPER_PART_CUT_A = CUT_PAPER(b'\x01')  # Partial cut paper function A
PAPER_FULL_CUT_B = CUT_PAPER(b'\x41')  # Full cut paper function B
PAPER_PART_CUT_B = CUT_PAPER(b'\x42')  # Partial cut paper function B

# Text format
SET_SIZE = lambda n: GS + b'!' + n
TXT_SIZE = GS + b'!'

SET_MODE = lambda n: ESC + b'!' + n
PRINT_MODE = ESC + b'!'
TXT_NORMAL = SET_MODE(b'\x00') # Normal text
